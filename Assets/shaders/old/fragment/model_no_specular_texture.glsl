...
void main() {
    ...
    for(int i = 0; i <= active_pointlight_qty; i++){
        result += calc_point_light(pointlight[i], diffuse_material, scenelight, normalized_frag_model_normals, view_direction, fragment_tex_coords, fragment_world_position);
    }
