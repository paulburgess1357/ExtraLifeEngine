...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::RenderComponent() and before the next ImGui::NewFrame(), which is also illegal.
    ...
    // RenderComponent helpers (those functions don't access any ImGui state!)
